...
//    output.Close();
    let samlmsgbytes = ASCIIEncoding.ASCII.GetBytes(respmsg)
    let samlmsg = Convert.ToBase64String samlmsgbytes
    let redirectUrl = "htttp://localhost:8080/idp?SamlMessage=" + samlmsg
