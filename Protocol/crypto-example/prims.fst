...
extern Runtime val ToUnicodeString: bytes -> string
extern Runtime val FromUnicodeString: string -> bytes
(* -------------------------------------------------------------------------------- *)
...
type Requires :: _ = fun ('a::*) ('R::heap => E) => 
    (DST 'a (fun ('Post::result 'a => heap => E) h => ('R h && (forall x h'. 'Post (V x) h'))))
type Ensures :: _ = fun ('a::*) ('E::heap => 'a => heap => E) => 
    (DST 'a (fun ('Post::result 'a => heap => E) h => (forall x h'. 'E h x h' ==> 'Post (V x) h')))
type Modifies :: _ = fun ('a::*) (x:ref 'a) (h:heap) (h':heap) =>
    (forall ('b::*) (y:ref 'b). ((not (Eq2 x y)) ==> (SelHeap h y = SelHeap h' y)
                                 && (InHeap h y ==> InHeap h' y)))
type ReqEns :: _ = fun ('a::*) ('R::heap => E) ('E::heap => 'a => heap => E) => 
